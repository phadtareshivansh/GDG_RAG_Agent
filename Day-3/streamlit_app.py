...
try:
    # prefer package-style imports if the project is installed as a package
    from DAY_3.rag_agent import RAGAgent
    from DAY_2.knowledge_base import KnowledgeBase
except ModuleNotFoundError:
    # Fallback: try the actual directory names in this workspace (Day-2 / Day-3)
    ...
    try:
        ...
        # As a last resort, also try legacy uppercase folder names if present
...
def main():
    ...
    with st.sidebar:
        ...
        uploaded_files = st.file_uploader(
            ...
            # accept plain text and markdown files
            type=['txt', 'md'],
        ...
        if prompt := st.chat_input("Ask about GDG events, workshops, or anything in the knowledge base..."):
            ...
            with st.chat_message("assistant"):
                with st.spinner("🤔 Thinking..."):
                    try:
                        # Get RAG response
                        # Use the prompt variable captured above
